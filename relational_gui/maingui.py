...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cmdUnion.setText(_translate("MainWindow", "ᑌ Ctrl+U", None))
        self.cmdUnion.setShortcut(_translate("MainWindow", "Ctrl+U", None))

        self.cmdIntersection.setToolTip(_translate("MainWindow", "Intersection", None))
        self.cmdIntersection.setText(_translate("MainWindow", "ᑎ Ctrl+I", None))
        self.cmdIntersection.setShortcut(_translate("MainWindow", "Ctrl+I", None))

        self.cmdDivision.setToolTip(_translate("MainWindow", "Division", None))
        self.cmdDivision.setText(_translate("MainWindow", "÷ Ctrl+D", None))
        self.cmdDivision.setShortcut(_translate("MainWindow", "Ctrl+D", None))

        self.cmdJoin.setToolTip(_translate("MainWindow", "Natural join", None))
        self.cmdJoin.setText(_translate("MainWindow", "ᐅᐊ Ctrl+J", None))
        self.cmdJoin.setShortcut(_translate("MainWindow", "Ctrl+J", None))
        ...
        self.cmdProjection.setText(_translate("MainWindow", "π Ctrl+P", None))
        self.cmdProjection.setShortcut(_translate("MainWindow", "Ctrl+P", None))

        self.cmdSelection.setToolTip(_translate("MainWindow", "Selection", None))
        self.cmdSelection.setText(_translate("MainWindow", "σ Ctrl+S", None))
        self.cmdSelection.setShortcut(_translate("MainWindow", "Ctrl+S", None))

        self.cmdRename.setToolTip(_translate("MainWindow", "Rename", None))
        self.cmdRename.setText(_translate("MainWindow", "ρ Ctrl+R", None))
        self.cmdRename.setShortcut(_translate("MainWindow", "Ctrl+R", None))

        self.cmdArrow.setText(_translate("MainWindow", "➡ Ctrl+T", None))
        self.cmdArrow.setShortcut(_translate("MainWindow", "Ctrl+T", None))
        ...
        self.cmdClearHistory.setText(_translate("MainWindow", "Clear history Ctrl+Q", None))
        self.cmdClearHistory.setShortcut(_translate("MainWindow", "Ctrl+Q", None))
